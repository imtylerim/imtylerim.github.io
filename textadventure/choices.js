	...
	if (times < 5) {
		...
		switch (times) {
			...
			case 2:
				...
				break;
			case 3:
				node = document.createTextNode("You work for 20 minutes. Your hand aches. 
					Your head is swimming.");
				break;
			case 4:
				node = document.createTextNode("You work for 20 minutes. You'll never finish. 
					You decide to stop working for tonight.");
				break;
		}
